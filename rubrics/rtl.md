...
|---|---|
| The code | `RTL-###` or `DOC-###`, exactly as written in the heading |
| The diagnosis name | The entry's `###` heading, **verbatim** — do not paraphrase it into something friendlier |
| The category | `Technical` or `Non-technical`, which the code prefix already encodes |
| **Fired on:** | The entry's `Signature` — the condition this resume actually met |

**Codes are permanent.** `RTL-###` is a technical finding, `DOC-###` a document-level one. They are assigned once in file order and are **append-only** — never renumbered, never reused, never re-prefixed. A retired entry keeps its code and is marked retired. Reports circulate as PDFs long after an entry is reworded, and a stable code is what keeps an old report referable. New entries take the next free number in their series, wherever they sit in the file.
...
### DOC-001 · Confidentiality exposure
...
### DOC-002 · Broken word spacing on export
...
### DOC-004 · Contact links present only as icons
...
### DOC-005 · Blank or near-empty page in the exported file
...
### DOC-006 · Years of experience never stated
...
### DOC-007 · Unfilled template placeholder
...
### DOC-008 · Summary paragraph with no heading
...
### DOC-009 · Career objective instead of a summary
...
### DOC-010 · Education placed above experience by a working professional
...
### DOC-011 · Recognisable client buried behind the staffing employer
...
### DOC-012 · Experience and projects in divorced sections
...
### DOC-013 · Training listed as professional experience
...
### DOC-014 · Prior role left undescribed
...
### DOC-015 · Contact block over-disclosure
...
### DOC-016 · Volunteering a weak metric
...
### DOC-017 · Seniority-inappropriate credentials
...
### DOC-019 · Unexplained gap in the timeline
...
### DOC-020 · Title velocity inside one employer, unexplained
...
### RTL-001 · Scope statement posing as accomplishment
...
### RTL-002 · Coordination verbs without artifacts
...
### RTL-003 · Specification register
...
### RTL-004 · Experience section carries no information
...
### RTL-005 · Primary identity claim unevidenced
...
### RTL-006 · Summary claim unevidenced
...
### RTL-007 · Role archetype mismatch, unbridged
...
### RTL-008 · Role-critical experience is the least developed item
...
### RTL-009 · Ownership claim immediately hedged
...
### RTL-010 · Passive voice removing the actor
...
### RTL-011 · Uniform bullet framing
...
### RTL-012 · Boilerplate recycled across entries
...
### RTL-013 · Output volume below tenure
...
### RTL-014 · Concreteness gradient running backwards
...
### RTL-015 · Capability list with no depth ranking
...
### RTL-016 · Company-internal tooling as transferable skill
...
### RTL-017 · Technical inaccuracy inside a skills list
...
### RTL-018 · Unquantified improvement claim
...
### RTL-019 · Flow-breadth claim disproportionate to tenure
...
### RTL-020 · Services-to-product transition, unbridged
...
### RTL-021 · Divided-intent signals
...
### RTL-022 · Tapeout or silicon claim without phase or scale
...
### RTL-023 · Adjacent-discipline evidence under an RTL banner
...
### RTL-024 · FPGA-only evidence against an ASIC requisition
...
### RTL-025 · Stint length below a project cycle
...
### DOC-021 · Employment structure unstated
...
### RTL-026 · Academic project indistinguishable from a course exercise
...
### RTL-027 · Verifiable public work absent or buried
...
### DOC-022 · Administrative content that does not belong
...
### DOC-023 · Location and work authorisation unstated
...
### DOC-024 · Career break stated but currency not addressed
...
### DOC-025 · First page carrying no claim
...
### RTL-029 · Latent qualifying experience never framed as such
...
### DOC-026 · Career pivot narrative left unsurfaced
...
### DOC-027 · Template → thin → template
...
### DOC-028 · Ambiguous concurrent dates
...
### RTL-030 · Projects ordered by date rather than by strength
...
### DOC-029 · Typo location over typo count
...
### DOC-030 · Tense and voice shifting within an entry
...
### RTL-031 · Domain-alien filler in the summary
